...
```
sudo runsc --root /run/containerd/runc/k8s.io ps ${CONTAINER_ID}
```
...
I0514 06:48:48.154263   18401 x:0] Args: [runsc --root /run/containerd/runc/k8s.io ps ce708d67e8cd69877b5470412ff4183fa38043e30a5ce40b0c6c1ab017137af5]
